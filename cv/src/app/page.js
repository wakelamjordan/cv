...
export default function Home() {
  ...
  return (
    <div className="font-[family-name:var(--font-geist-sans)] p-2 grid gap-2 relative text-base-content">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="grid gap-3">
              ...
              <div>
                ...
                >
                  <FontAwesomeIcon icon={"fas fa-envelope"} className="mx-1" />{" "}
              ...
              <div>
                <Link
                  ...
                  target="_blank"
                >
                  <FontAwesomeIcon icon={"fab fa-linkedin"} className="mx-1" />{" "}
